...
// Importujemy nasz nowy hook zamiast funkcji API
...
function MetricsPage() {
    ...
    return (
        <Col className="section-container d-flex flex-column p-5 gap-3 w-100 overflow-hidden"
             style={{height: "calc(100vh - var(--nav-height) - 2 * var(--section-margin))"}}>
            ...
            <Tabs
                ...
                fill={true}
            >
                <Tab eventKey="predefined" title="Predefined Metrics"
                     className="tab-group d-flex flex-column flex-grow-1">
