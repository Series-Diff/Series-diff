  ...
  return filtered;
    ...
    const autoCorrelations = await fetchAllAutoCorrelations(names, start, end);
                ...
                for (const category of Object.keys(names)) {
                    ...
                    allPearsonCorrelations[category] = await fetchAllPearsonCorrelations(files, category, start, end);
...
useEffect(() => {
  ...
  const secondary = processCategory(secondaryCategory);
        ...
        }, [chartData, selectedCategory, secondaryCategory, rangePerCategory, startDate, endDate, rollingMeanChartData, showMovingAverage, maWindow]);
