                    ...
                    {Object.keys(groupedMetrics).length > 0 && (
                        <div className="section-container" style={{ padding: "16px" }}>
                            <div className="d-flex justify-content-end align-items-center">
                                {isExporting && <Spinner animation="border" size="sm" className="me-2" />} {/* Po lewej od przycisku */}
                                <Button
                                    variant="secondary"
            ...
            <Modal show={showTitleModal} onHide={() => setShowTitleModal(false)} centered>
                ...
                <Modal.Body>
                    <Form.Control
                        type="text"
                        value={reportTitle}
                        onChange={(e) => setReportTitle(e.target.value.slice(0, 30))} // Limit 30
                        placeholder="Enter title (max 30 characters)"
                        required // Not empty
                        isInvalid={reportTitle.length === 0 || reportTitle.length > 30} // UI validation
                    />
