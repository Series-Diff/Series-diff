        ...
        <Modal show={show} onHide={onHide} size="lg" centered scrollable>
            ...
            <Modal.Body style={{ maxHeight: '60vh' }}>
                ...
                <div className="mb-3">
                    ...
                    <p className="mb-0" style={{ fontSize: '0.95rem' }}>{metricInfo.interpretation}</p>
                </div>

                <div className="mb-3">
                    <h6 className="text-muted mb-2" style={{ fontSize: '0.9rem' }}>Value Range:</h6>
                    <p className="mb-0">
                        <code className="bg-light px-2 py-1 rounded" style={{ fontSize: '0.9rem' }}>{metricInfo.range}</code>
                    </p>
                </div>
