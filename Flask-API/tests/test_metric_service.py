...
class TestCalculateDifference(unittest.TestCase):
    ...
    def test_empty_series(self):
        # Empty series now returns empty dict instead of raising ValueError
        result = calculate_difference({}, {"2023-01-01": 1})
        self.assertEqual(result, {})
...
class TestCalculateDTW(unittest.TestCase):
    ...
    def test_empty_series(self):
        # Empty series now returns None instead of raising ValueError
        result = calculate_dtw({}, {"2023-01-01": 1})
...
class TestCalculateEuclideanDistance(unittest.TestCase):
    ...
    def test_empty_series(self):
        # Empty series now returns None instead of raising ValueError
        result = calculate_euclidean_distance({}, {"2023-01-01": 1})
        self.assertIsNone(result)
