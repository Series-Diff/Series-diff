...
def create_target_group(vpc_id: str, environment: str) -> aws.lb.TargetGroup:
    ...
    target_group = aws.lb.TargetGroup(
        ...
        tags={"Name": f"flask-{environment}-tg", "Environment": environment},
    )
...
def create_alb(
    ...
    alb = aws.lb.LoadBalancer(
        ...
        tags={"Name": f"flask-api-{environment}-alb", "Environment": environment},
    )
    ...
    if cognito_config:
        ...
        https_listener = aws.lb.Listener(
            ...
            default_actions=[
                ...
                aws.lb.ListenerDefaultActionArgs(
                    type="forward", target_group_arn=target_group.arn, order=2
                ),
            ],
            tags={
    ...
    http_listener = aws.lb.Listener(
        ...
        tags={"Name": f"alb-http-listener-{environment}", "Environment": environment},
    )
