...
from modules.ecs import create_ecs_cluster, create_ecs_task_definition, create_ecs_service
...
pulumi.export("amplify_custom_domain", pulumi.Output.concat("https://", config.fe_subdomain, ".", config.hosted_zone_domain))
